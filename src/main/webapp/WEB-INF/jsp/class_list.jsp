<%@ page contentType="text/html;charset=UTF-8" language="java"  import="com.xunmaw.dormitory.po.Class" %>
                ...
                $.ajax({
                    ...
                    success:function(res){
                        if (res == "success"){
                            ...
                            layer.msg('班级编号不可重复，添加失败', {icon: 2, time: 1000});
                        }
                    },
                    error:function(){
                        layer.msg('服务器出问题啦，请检查',{icon:0,time:3000});
                        setTimeout(function () {window.location.href='/findClass';},2000);
                    }
                });
                // return false;
